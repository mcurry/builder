 ...
 */
  ...
  Router::connect('/install', array('controller' => 'users', 'action' => 'install'));
	Router::connect('/instances/add/:site_id', array('controller' => 'instances', 'action' => 'add'), array('site_id' => '[0-9]+'));
